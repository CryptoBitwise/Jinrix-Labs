                ...
                <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-white/40 dark:supports-[backdrop-filter]:bg-black/30 border-b border-zinc-200/50 dark:border-zinc-800/60">
                    <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a href="#contact" className="hidden sm:inline-flex rounded-xl px-3 py-2 text-sm text-zinc-700 dark:text-zinc-200 hover:text-white hover:bg-zinc-900/80 dark:hover:bg-zinc-100/10 transition">Contact</a>
                                            ...
                                            <div className="relative z-10">
                                                <div className="mb-2 inline-flex items-center gap-2 text-sm font-medium">
                                                    <span className="relative inline-flex h-6 w-6 items-center justify-center">
                                                        ...
                                                        <span className={`absolute inset-0 flex items-center justify-center rounded-lg bg-zinc-900 text-white dark:bg-white dark:text-zinc-900 transition-opacity duration-300 ${showAltIcons ? 'opacity-100 group-hover:opacity-0' : 'opacity-0 group-hover:opacity-100'}`}>{conceptApps[4].altIcon}</span>
                                                    </span>
                                                    <span className="inline-flex w-7 justify-center">
                                                        <span className="inline-flex h-5 w-5 items-center justify-center rounded-lg bg-white text-zinc-900 ring-1 ring-white/70 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                                                            {conceptApps[4].legacyIcon}
                                                        </span>
                                                    </span>
                                                    {conceptApps[4].name}
                                                </div>
                                                <p className="text-xs text-zinc-500 dark:text-zinc-400">{conceptApps[4].description}</p>
                                            </div>
                                        </a>
                                    </div>
                                </div>
